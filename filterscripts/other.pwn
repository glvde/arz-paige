...
public OnFilterScriptInit()
{
	...
	actor[251] = CreateActor(164, 1531.4680, 1114.0533, 1033.8420, 180.5298);
	SetActorVirtualWorld(actor[251], 2);
	actor[252] = CreateActor(164, 1542.1630, 1114.0559, 1033.8420, 180.5298);
	SetActorVirtualWorld(actor[252], 2);
	actor[253] = CreateActor(164, 1537.0295, 1114.0533, 1033.8420, 181.1565);
	SetActorVirtualWorld(actor[253], 3);
	...
	actor[258] = CreateActor(3, 1129.1080, -1433.9572, 15.7969, 357.8926);
	...
	CreateDynamic3DTextLabel("{A19D9D}Открыть\n{FFFFFF}H", -1, 1490.3296,-1281.2520,113.8064, 5.0);
	...
	CreateDynamic3DTextLabel("Трудоустройство\n{FFFFFF}Нажмите: ALT",COLOR_VALIK, -77.9217,90.3327,3.1172,5.0);
	...
	CreateDynamic3DTextLabel("Буфет", -1, 1501.7886, -1247.8163, 113.8103, 20.0);
	...
	CreatePickup(1239, 1, 1471.7279, -1271.7294, 113.8103, -1);
	...
	CreatePickup(1314, 23, 1474.5449, -1266.0454, 113.8103, -1);//выборы
	CreatePickup(1314, 23, 1478.9395, -1266.2124, 113.8103, -1);//планировка дома
